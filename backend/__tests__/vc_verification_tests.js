...
describe("POST /vc/verifyDeep", () => {
    it("should return 200 and a valid message", async () => {
        ...
        const studentuVCBuilder = new UnsignedVCBuilder("BachelorDegree", "date", uniDID, studentDID, studentVCClaims);
        ...
        const uniuVCBuilder = new UnsignedVCBuilder("DiplomaIssuing", "date", rootDID, uniDID, universityVCClaims);
        ...
        const rootuVCBuilder = new UnsignedVCBuilder("Authorization", "date", rootDID, rootDID, rootVCClaims);
